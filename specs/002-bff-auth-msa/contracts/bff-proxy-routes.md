...
| Core | `POST /api/v1/spaces/{spaceId}/invitations`, `POST /api/v1/spaces/{spaceId}/invitations/{invitationId}/accept|decline`, `GET /api/v1/glossary/categories`, `GET|POST /api/v1/spaces/{spaceId}/terms`, `PATCH|DELETE /api/v1/spaces/{spaceId}/terms/{termId}` |
