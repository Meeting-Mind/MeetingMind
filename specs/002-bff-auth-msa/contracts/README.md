...
| `auth-service-api.md` | Web BFF ↔ Auth Service | Target, T033 keys-complete | 자격/refresh/revoke, KMS signing/JWKS와 비활성 Resource validator는 구현됐고 실제 BFF/Core dual-validation cutover는 T035에서 수행한다. |
