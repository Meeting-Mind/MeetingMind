...
final class CoreWorkloadIdentityFilter extends OncePerRequestFilter {
    ...
    private void writeError(
        ...
        objectMapper.writeValue(
                ...
                new AuthErrorResponse(
                        ...
                        message,
                        List.of(),
                        com.meetingmind.demo.observability.RequestTrace.currentOrCreate()));
    }
}
